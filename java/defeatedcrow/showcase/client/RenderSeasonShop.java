...
public class RenderSeasonShop extends TileEntitySpecialRenderer {
	private static final ResourceLocation TILE_TEX = new ResourceLocation("showcase:textures/tiles/seasons_monitor.png");
	public static RenderSeasonShop caseRenderer;
	private ModelShopTile model = new ModelShopTile();

	public void renderTileEntityCaseAt(TileSeasonShop par1Tile, double par2, double par4, double par6, float par8) {
	...
	public void setRotation(TileSeasonShop par0Tile, float par1, float par2, float par3) {
		ModelShopTile model = this.model;
		byte l = (byte) par0Tile.getBlockMetadata();
		IIcon iicon = par0Tile.getSeasoonIcon();
	...
	public void renderTileEntityAt(TileEntity par1TileEntity, double par2, double par4, double par6, float par8) {
		this.renderTileEntityCaseAt((TileSeasonShop) par1TileEntity, par2, par4, par6, par8);
	}
}
